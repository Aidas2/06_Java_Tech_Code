            ...
            <form onSubmit={props.handleSubmit}>
                ...
                <div className="form-row">
                    <div className="col-md-4 col-lg-4 mb-3">
                        ...
                        <input type="text" className="form-control" id="title" value={props.currentTitle} required
                                onChange={props.handleChangeOfTitle} pattern="^[a-zA-ZÀ-ž\s]+$" maxLength="30"
                ...
                <div className="form-row">
                    <div className="col-md-8 col-lg-8 mb-3">
                        ...
                        <input type="text" className="form-control" id="description" value={props.currentPresident}
                                required onChange={props.handleChangeOfPresident} pattern="^[a-zA-ZÀ-ž\s]+$" maxLength="50"
