...
class UserStatisticsContainer extends React.Component {
    ...
    handleChartUpdate = event => {
        ...
        axios.post("http://localhost:8081/api/stats/docTypes/users", 
            { documentTypes: this.state.selectedDocTypes, usersPerType: this.state.numberOfEmployees }
        ).then(response => {
                                ...
                                <div className="card-body">
                                    <div className="row justify-content-md-center">
                                        <UserStatisticsFormComponent
                                            ...
                                            handleChangeOfnumberOfEmployees={this.handleChangeOfnumberOfEmployees}
