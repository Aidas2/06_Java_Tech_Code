...
var productListFromMap = productMap;
...
class App extends Component {
  constructor(props) {
    super(props);
    this.state = {Title: props.pavadinimas};
    console.log('Mes esame konstruktoriuje');
  }
  render() {
    console.log('Mes esame renderyje');
    return (
      <div className="App">
...
componentDidMount() {
  console.log('Ivyko metodas componentDidMount');
}

static getDerivedStateFromProps() {
  console.log('Ivyko metodas getDerivedStateFromProps');
  return null;
}
