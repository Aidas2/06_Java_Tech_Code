...
//sio masyvo,  nebereikia, duomenys imami is interneto (https://itpro2017.herokuapp.com/api/products) per axios
// App.js irgi nebereikia, nes i index.js paduodamas nebe jis, o kruva kitu komponentu
var all_products = [ 
  {
...
class MyProvider extends Component {
  render() {
    return (
      <ServicesContext.Provider value="Aidas">
        {this.props.children}
...
var filteredProductList = all_products.filter(product => product.price <= 10);
