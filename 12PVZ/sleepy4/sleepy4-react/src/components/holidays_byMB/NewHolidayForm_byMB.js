...
class NewHolidayForm_byMB extends Component {
  constructor() {
    super();
    this.state = {
      title: "From Create Constructor 1",
      description: "",
      type: "PUBLIC",
      imageOfHoliday: "",
      isFlagRaised: "",
  ...
  componentDidMount() {
    console.log("zinute is tuscio componentDidMount. ");
  ...
  handleSubmit(event) {
    ...
    axios
      .post("http://localhost:8081/api/holidays", this.state)
      .then(response => {
    ...
    this.setState({
      title: "From Create Constructor 2",
      description: "",
      type: "PUBLIC",
      imageOfHoliday: "",
      isFlagRaised: "",
...
export default NewHolidayForm_byMB;
