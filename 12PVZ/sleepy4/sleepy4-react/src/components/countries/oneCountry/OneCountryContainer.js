...
class OneCountryContainer extends Component{
    ...
    handleDelete = (event) => {
        ...
        console.log('http://localhost:8081/api/countries/delete/' + (this.props.title));
        axios.delete('http://localhost:8081/api/countries/delete/' + (this.props.title))
        .then((response) => {
        ...
        return(
            <div>
                ...
                <OneCountryComponent
                    ...
                    imageOfFlag={this.props.imageOfFlag}
